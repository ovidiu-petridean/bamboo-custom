...
func init() {
//	flag.StringVar(&configFilePath, "config", "/home/opetridean/go/src/github.com/QubitProducts/bamboo/config/development.json", "Full path of the configuration JSON file")
